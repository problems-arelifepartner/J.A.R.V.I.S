...
# Fork the tool befor using it and give the <a href="https://www.aistudio.google.com"> </a> API in the api_key.txt file located inside the J.A.R.V.I.S/jarvis-terminal
```
